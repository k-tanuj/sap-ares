          ...
          {activeTab === "network" && (
            <div className="bg-white border border-slate-200 rounded shadow-sm p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-slate-100 pt-6">
                  <h4 className="text-sm font-bold text-slate-700 uppercase tracking-wide mb-3">Geographic Node Visual Flow</h4>
                  <div className="bg-slate-50 border border-slate-200 p-4 rounded text-sm font-mono space-y-2">
                    <div className="flex items-center space-x-2">
                      <span className="bg-red-200 text-red-800 px-2 py-0.5 rounded font-bold">DISRUPTED</span>
                      <span>SinoChip (Shenzhen, China) ── [RT-OCEAN-CN-DE (Ocean: 28d, $2)] ──&gt; Munich Plant (Deficit Stock)</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="bg-indigo-200 text-indigo-800 px-2 py-0.5 rounded font-bold">ALT ROUTE</span>
                      <span>SinoChip (Shenzhen, China) ── [RT-AIR-CN-DE (Air: 5d, $10)] ──&gt; Munich Plant (Fast Track)</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="bg-emerald-250 text-emerald-800 px-2 py-0.5 rounded font-bold">SAFE LOCAL</span>
                      <span>Bavarian Micro (Munich, Germany) ── [RT-ROAD-DE-DE (Road: 2d, $1)] ──&gt; Munich Plant (Resilient)</span>
                    </div>
                  </div>
                </div>
              </div>
